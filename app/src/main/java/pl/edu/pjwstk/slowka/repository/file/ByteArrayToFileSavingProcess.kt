...
class ByteArrayToFileSavingProcess(data: ByteArray, fileName: String, sizeRect: Rect) : FileSavingProcess<YuvImage>(fileName) {
    ...
    override fun finally(dataOfType: YuvImage) {
        // NO OP
    }
}
